...
page_header("Spectacles / Show");
?>
<section>
    <article>
        <h2>Spectacle destiné aux enfants</h2>
        <p>Les aventures d’Henry.
            Henry un jeune de 18 ans recherche l’aventure, il tombe nez à nez face à un magicien s’appelant Merlin
            et l’envoya dans un livre
    ...
    <article>
        ...
        <p>
            ...
            spectacles de magie encore plus divertissants et mémorables.
        </p>
